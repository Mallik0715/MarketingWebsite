...
import { Utensils, ShoppingBag, Bike, ChefHat } from 'lucide-react'
...
const ServiceCard = ({ service, index }: { service: Service; index: number }) => {
  ...
  return (
    ...
    >
      {/* Smooth filling green gradient overlay */}
      <div
...
const ServicesSection = () => {
  return (
    <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-b from-gray-50 to-white">
