...
export default function About() {
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 lg:py-16 bg-linear-to-br from-[#1a2f5c] via-[#1e3a6b] to-[#2d4a8f]">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 animate-fadeInUp">
          <div className="inline-block px-4 py-2 bg-white/20 backdrop-blur-sm text-white rounded-full text-xl font-semibold mb-4 border border-white/30">
            About Us
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value, index) => (
            ...
            >
              <div className="w-16 h-16 bg-linear-to-br from-orange-400 to-yellow-300 rounded-2xl flex items-center justify-center mb-6 shadow-lg">
        ...
        <div className="mt-20 bg-white/10 backdrop-blur-lg border-2 border-white/20 rounded-3xl p-12 text-center text-white">
          ...
          <button className="px-10 py-4 bg-linear-to-r from-orange-400 to-yellow-300 text-blue-900 rounded-xl font-bold text-lg hover:shadow-2xl hover:from-orange-300 hover:to-yellow-200 transform hover:scale-105 transition-all">
            Get Started Today
          </button>
        </div>
      </div>
