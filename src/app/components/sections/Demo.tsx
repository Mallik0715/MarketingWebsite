  ...
  return (
    <div className="relative py-20 px-4 sm:px-6 lg:px-8 bg-white overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        {/* Header */}
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-blue-50 border border-blue-200 text-blue-700 rounded-full text-2xl font-semibold mb-4">
        ...
        <div
          ...
          onTouchEnd={(e) => handleDragEnd(e.changedTouches[0].clientX)}
        >
          {/* ✅ Removed overlapping navigation buttons */}
